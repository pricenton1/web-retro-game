    ...
    <footer className="w-full max-w-5xl mx-auto mt-auto pt-10 border-t border-gray-800 flex flex-col md:flex-row items-center md:items-start justify-between gap-8 pb-8">
      ...
      <div className="flex flex-col items-center md:items-end gap-3">
        ...
        <div className="flex items-center gap-5">
          <a href="https://linkedin.com/in/username-kamu" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-blue-500 transition-colors duration-300" aria-label="LinkedIn">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
          </a>
          <a href="https://github.com/username-kamu" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-white transition-colors duration-300" aria-label="GitHub">
          ...
          <a href="mailto:email-kamu@gmail.com" className="text-gray-500 hover:text-red-400 transition-colors duration-300" aria-label="Email">
